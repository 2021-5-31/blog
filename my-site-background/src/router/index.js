...
export const constantRoutes = [
  ...
  },
  {
    ...
    children: [{
      ...
      meta: { title: '首页标语', icon: 'el-icon-star-on' , auth:true}
    }]
  },

  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: { title: '编辑文章', icon: 'el-icon-document-edit' , auth:true}
      }
    ]
  },
  {
    ...
    children: [
      {
        ...
        meta: { title: '留言板管理', icon: 'el-icon-chat-dot-round' , auth:true}
      }
    ]
  },
  {
